    ...
    navigation: [
      {
        ...
        title: t("onboarding.steps.mobile.navigationNav.title"),
        description: t("onboarding.steps.mobile.navigationNav.description"),
        target: '[data-onboarding="mobile-nav"]',
        requiredAction: "click-target",
        actionPrompt: t("onboarding.steps.mobile.navigationNav.action"),
      },
      {
        ...
        target: '[data-onboarding="task-list"]',
        requiredAction: "click-target",
        actionPrompt: t("onboarding.steps.mobile.navigationFocus.action"),
      },
      {
        ...
        target: '[data-onboarding="focused-breadcrumb"]',
        requiredAction: "click-target",
        actionPrompt: t("onboarding.steps.mobile.navigationBreadcrumb.action"),
      },
    ],
    filters: [
      {
        id: "mobile-filters-open",
        title: t("onboarding.steps.mobile.filtersOpen.title"),
        description: t("onboarding.steps.mobile.filtersOpen.description"),
    ...
    compose: [
      {
        ...
        title: t("onboarding.steps.mobile.composeCombobox.title"),
        description: t("onboarding.steps.mobile.composeCombobox.description"),
        target: '[data-onboarding="mobile-combined-box"]',
        requiredAction: "click-target",
        actionPrompt: t("onboarding.steps.mobile.composeCombobox.action"),
      },
    ],
  };

...
export const APP_PREFERENCE_DEFINITIONS: AppPreferenceDefinition[] = [
  {
    ...
    descriptionKey: "filters.profile.presenceDescription",
  ...
  },
  {
    ...
    descriptionKey: "filters.profile.undoSendDescription",
    surfaces: ["desktop", "mobile"],
  },
  {
    key: "autoCaption",
    ...
    descriptionKey: "filters.profile.autoCaptionDescription",
    surfaces: ["desktop"],
  },
];

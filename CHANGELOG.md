...
- Breadcrumb labels no longer pre-abbreviate task text, now stay left-aligned on a single line, and only truncate when layout space is actually constrained.

...
- The desktop sidebar gained a Projects section listing active top-level tasks with open subtasks, plus indented active subprojects; clicking a row focuses that project.

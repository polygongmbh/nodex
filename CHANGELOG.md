...
- Desktop feed panes no longer recompute timeline empty-state overlays in both the parent pane and the feed itself, reducing duplicate work and preventing the shared overlay path from interfering with feed interactions.

...
- Signing in again after logout now hard-reconnects relays that were `read rejected`, so NIP-42 auth can re-run immediately with the new signer instead of staying stuck until full page reload.

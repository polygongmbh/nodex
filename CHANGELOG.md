...
- Table view now shows compact icons in column headers, and priority dropdown styling is flatter/cleaner in both Table and composer controls to better match the surrounding UI.

...
- Profile dropdown now uses a slightly wider compact layout with inline `Edit profile` next to the profile preview, flattened app-preference toggles (no nested card wrappers), and clearer preference labels with explanatory hover tooltips.

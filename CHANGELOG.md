...
- The desktop sidebar gained a Projects section listing active top-level tasks with open subtasks, plus indented active subprojects; clicking a row focuses that project. In the Home view it replaces the breadcrumb bar: the rows containing the focused post are highlighted to show your current position.

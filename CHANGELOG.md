...
- Sidebar People filters now include fallback author entries derived from visible task/demo-feed authors when kind:0 profile metadata has not loaded yet.

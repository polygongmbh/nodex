...
- Your profile now follows you onto your relays: after signing in — and again when a new relay connects — Nodex checks whether the connected relays already hold your profile (`kind:0`) and, if none is found, publishes your current profile so your name and picture show up there. An existing profile is never overwritten or needlessly republished, and guest identities are never published this way. This mainly helps Noas / private-key logins whose profile previously lived only in the app until you opened the profile editor.

...
- The calendar view's selected-day panel now has both "Add Task" and "Add Event" buttons, each opening the composer pre-set to the right mode with the day as the start/due date.

...
- Feed/tree/table scope hints now show a true end-of-content footer (`Showing only tasks ...`) when filtered results are visible, while `No post yet ...` remains reserved for actual zero-result states.

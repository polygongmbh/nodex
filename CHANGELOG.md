...
- Every mobile view now shows a horizontally scrollable channel-chip row under the nav bar. Tapping a channel chip scopes the view to just that channel; tapping it again (or the Home chip) clears it. Long-press a chip to pin/unpin it. Chips are your pinned channels (in pin order), falling back to the most-used ones until you pin some. The burger/manage menu moved out of the view switcher into this row as its first chip. On the feed and status timeline, the Home chip shows top-level posts from your pinned channels plus anything involving you (authored, assigned, or replies under your posts).
